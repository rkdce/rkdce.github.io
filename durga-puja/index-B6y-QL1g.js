...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=vt(),d;if(t){let e=typeof t==`string`?se(t):t;E(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=n&&n.state.matches.length?n.state.matches.map(e=>Object.assign(e,{route:n.manifest[e.route.id]||e.route})):O(e,{pathname:p});ne(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),ne(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=Pt(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Fe([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Fe([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?x.createElement(ct.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,mask:void 0,...d},navigationType:`POP`}},h):h}function Ot(){let e=Vt(),t=Ve(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=x.createElement(x.Fragment,null,x.createElement(`p`,null,`💿 Hey developer 👋`),x.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,x.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,x.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),x.createElement(x.Fragment,null,x.createElement(`h2`,null,`Unexpected Application Error!`),x.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?x.createElement(`pre`,{style:i},n):null,o)}var kt=x.createElement(Ot,null),At=class extends x.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=ht(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:x.createElement(lt.Provider,{value:this.props.routeContext},x.createElement(ut.Provider,{value:e,children:this.props.component}));return this.context?x.createElement(Mt,{error:e},t):t}};At.contextType=nt;var jt=new WeakMap;function Mt({children:e,error:t}){let{basename:n,navigator:r}=x.useContext(st);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=mt(t.digest);if(e){let i=jt.get(t);if(i)throw i;let a=We(e.location,n),o=a.absoluteURL||a.to;if(Ye(e.location,o,Ke(r),`allow-explicit`),$e(o))throw Error(`Invalid redirect location`);if(Ue&&!jt.get(t)){if(a.isExternal||e.reloadDocument)window.location.href=o;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(a.to,{replace:e.replace}));throw jt.set(t,n),n}}return x.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${o}`})}}return e}function Nt({routeContext:e,match:t,children:n}){let r=x.useContext(et);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(lt.Provider,{value:e},n)}function Pt(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);E(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},pattern:He(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||kt,o&&(s<0&&c===0?(Wt(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?x.createElement(n.route.Component,null):n.route.element?n.route.element:e,x.createElement(Nt,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?x.createElement(At,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function Ft(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function It(e){let t=x.useContext(et);return E(t,Ft(e)),t}function Lt(e){let t=x.useContext(tt);return E(t,Ft(e)),t}function Rt(e){let t=x.useContext(lt);return E(t,Ft(e)),t}function zt(e){let t=Rt(e),n=t.matches[t.matches.length-1];return E(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function Bt(){return zt(`useRouteId`)}function Vt(){let e=x.useContext(ut),t=Lt(`useRouteError`),n=zt(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Ht(){let{router:e}=It(`useNavigate`),t=zt(`useNavigate`),n=x.useRef(!1);return bt(()=>{n.current=!0}),x.useCallback(async(r,i={})=>{ne(n.current,yt),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var Ut={};function Wt(e,t,n){!t&&!Ut[e]&&(Ut[e]=!0,ne(!1,n))}x.memo(Gt);function Gt({routes:e,manifest:t,future:n,state:r,isStatic:i,onError:a}){return Dt(e,void 0,{manifest:t,state:r,isStatic:i,onError:a,future:n})}function Kt({to:e,replace:t,state:n,relative:r}){E(_t(),`<Navigate> may be used only in the context of a <Router> component.`);let{static:i,navigator:a}=x.useContext(st);ne(!i,`<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`);let{matches:o}=x.useContext(lt),{pathname:s}=vt(),c=xt(),l=Ne(e,Me(o),s,r===`path`);Ye(typeof e==`string`?e:oe(e),a.createHref(l),Ke(a),`reject`);let u=JSON.stringify(l);return x.useEffect(()=>{c(JSON.parse(u),{replace:t,state:n,relative:r})},[c,u,r,t,n]),null}function qt(e){return wt(e.context)}function A(e){E(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Jt({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,useTransitions:o}){E(!_t(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=x.useMemo(()=>({basename:s,navigator:i,static:a,useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=se(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,mask:m}=n,h=x.useMemo(()=>{let e=De(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return ne(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:x.createElement(st.Provider,{value:c},x.createElement(ct.Provider,{children:t,value:h}))}function Yt({children:e,location:t}){return Et(Xt(e),t)}x.Component;function Xt(e,t=[]){let n=[];return x.Children.forEach(e,(e,r)=>{if(!x.isValidElement(e))return;let i=[...t,r];if(e.type===x.Fragment){n.push.apply(n,Xt(e.props.children,i));return}E(e.type===A,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),E(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Xt(e.props.children,i)),n.push(a)}),n}var Zt=`get`,Qt=`application/x-www-form-urlencoded`;function $t(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function en(e){return $t(e)&&e.tagName.toLowerCase()===`button`}function tn(e){return $t(e)&&e.tagName.toLowerCase()===`form`}function nn(e){return $t(e)&&e.tagName.toLowerCase()===`input`}function rn(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function an(e,t){return e.button===0&&(!t||t===`_self`)&&!rn(e)}var on=null;function sn(){if(on===null)try{new FormData(document.createElement(`form`),0),on=!1}catch{on=!0}return on}var cn=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function ln(e){return e!=null&&!cn.has(e)?(ne(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Qt}"`),null):e}function un(e,t){let n,r,i,a,o;if(tn(e)){let o=e.getAttribute(`action`);r=o?De(o,t):null,n=e.getAttribute(`method`)||Zt,i=ln(e.getAttribute(`enctype`))||Qt,a=new FormData(e)}else if(en(e)||nn(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?De(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Zt,i=ln(e.getAttribute(`formenctype`))||ln(o.getAttribute(`enctype`))||Qt,a=new FormData(o,e),!sn()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if($t(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Zt,r=null,i=Qt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function dn(e,t){if(e===!1||e==null)throw Error(t)}function fn(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return i.pathname=n?i.pathname.endsWith(`/`)?`${i.pathname}_.${r}`:`${i.pathname}.${r}`:i.pathname===`/`?`_root.${r}`:t&&De(i.pathname,t)===`/`?`${Ie(t)}/_root.${r}`:`${Ie(i.pathname)}.${r}`,i}async function pn(e,t){if(e.id in t)return t[e.id];try{let n=await b(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function mn(e){return e!=null&&typeof e.page==`string`}function hn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function gn(e,t,n){return xn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await pn(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(hn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function _n(e,t,n,r,i,a){let o=(e,t)=>!n[t]||e.route.id!==n[t].route.id,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function vn(e,t,{includeHydrateFallback:n}={}){return yn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function yn(e){return[...new Set(e)]}function bn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function xn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!mn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(bn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function Sn(){let e=x.useContext(et);return dn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function Cn(){let e=x.useContext(tt);return dn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var wn=x.createContext(void 0);wn.displayName=`FrameworkContext`;function Tn(){let e=x.useContext(wn);return dn(e,`You must render this element inside a <HydratedRouter> element`),e}function En(e,t){let n=x.useContext(wn),[r,i]=x.useState(!1),[a,o]=x.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=x.useRef(null);x.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),x.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:Dn(s,p),onBlur:Dn(c,m),onMouseEnter:Dn(l,p),onMouseLeave:Dn(u,m),onTouchStart:Dn(d,p)}]:[a,f,{}]:[!1,f,{}]}function Dn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function On({page:e,...t}){let n=rt(),{nonce:r}=Tn(),{router:i}=Sn(),a=x.useMemo(()=>O(i.routes,e,i.basename),[i.routes,e,i.basename]);return a?(t.nonce==null&&r&&(t={...t,nonce:r}),n?x.createElement(An,{page:e,matches:a,...t}):x.createElement(jn,{page:e,matches:a,...t})):null}function kn(e){let{manifest:t,routeModules:n}=Tn(),[r,i]=x.useState([]);return x.useEffect(()=>{let r=!1;return gn(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function An({page:e,matches:t,...n}){let r=vt(),{future:i}=Tn(),{basename:a}=Sn(),o=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=fn(e,a,i.v8_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.v8_trailingSlashAwareDataRequests,e,r,t]);return x.createElement(x.Fragment,null,o.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function jn({page:e,matches:t,...n}){let r=vt(),{future:i,manifest:a,routeModules:o}=Tn(),{basename:s}=Sn(),{loaderData:c,matches:l}=Cn(),u=x.useMemo(()=>_n(e,t,l,a,r,`data`),[e,t,l,a,r]),d=x.useMemo(()=>_n(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];t&&t.hasLoader&&(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=fn(e,s,i.v8_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.v8_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=x.useMemo(()=>vn(d,a),[d,a]),m=kn(d);return x.createElement(x.Fragment,null,f.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>x.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>x.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function Mn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}x.Component;var Nn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{Nn&&(window.__reactRouterVersion=`7.18.3`)}catch{}function Pn({basename:e,children:t,useTransitions:n,window:r}){let i=x.useRef();i.current??=te({window:r,v5Compat:!0});let a=i.current,[o,s]=x.useState({action:a.action,location:a.location}),c=x.useCallback(e=>{n===!1?s(e):x.startTransition(()=>s(e))},[n]);return x.useLayoutEffect(()=>a.listen(c),[a,c]),x.createElement(Jt,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,useTransitions:n})}var Fn=x.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,useTransitions:_}=x.useContext(st),v=typeof l==`string`&&S.test(l),y=We(l,h);l=y.to;let b=gt(l,{relative:r}),C=vt(),w=null;if(o){let e=Ne(o,[],C.mask?C.mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Fe([h,e.pathname])),w=g.createHref(e)}let[T,ee,te]=En(n,p),E=Bn(l,{replace:a,mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,defaultShouldRevalidate:f,useTransitions:_});function ne(t){e&&e(t),t.defaultPrevented||E(t)}let re=!(y.isExternal||i),ie=x.createElement(`a`,{...p,...te,href:(re?w:void 0)||y.absoluteURL||b,onClick:re?ne:e,ref:Mn(m,ee),target:c,"data-discover":!v&&t===`render`?`true`:void 0});return T&&!v?x.createElement(x.Fragment,null,ie,x.createElement(On,{page:b})):ie});Fn.displayName=`Link`;var In=x.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=Tt(a,{relative:c.relative}),d=vt(),f=x.useContext(tt),{navigator:p,basename:m}=x.useContext(st),h=f!=null&&Gn(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=De(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,b=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,S=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),C={isActive:b,isPending:S,isTransitioning:h},w=b?e:void 0,T;T=typeof n==`function`?n(C):[n,b?`active`:null,S?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let ee=typeof i==`function`?i(C):i;return x.createElement(Fn,{...c,"aria-current":w,className:T,ref:l,style:ee,to:a,viewTransition:o},typeof s==`function`?s(C):s)});In.displayName=`NavLink`;var Ln=x.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Zt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m)=>{let{useTransitions:h}=x.useContext(st),g=Un(),_=Wn(s,{relative:l}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&S.test(s);return x.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f});h&&n!==!1?x.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});Ln.displayName=`Form`;function Rn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function zn(e){let t=x.useContext(et);return E(t,Rn(e)),t}function Bn(e,{target:t,replace:n,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c,useTransitions:l}={}){let u=xt(),d=vt(),f=Tt(e,{relative:o});return x.useCallback(p=>{if(an(p,t)){p.preventDefault();let t=n===void 0?oe(d)===oe(f):n,m=()=>u(e,{replace:t,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c});l?x.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}var Vn=0,Hn=()=>`__${String(++Vn)}__`;function Un(){let{router:e}=zn(`useSubmit`),{basename:t}=x.useContext(st),n=Bt(),r=e.fetch,i=e.navigate;return x.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=un(e,t);if(a.navigate===!1){let e=a.fetcherKey||Hn();await r(e,n,a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync})}else await i(a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Wn(e,{relative:t}={}){let{basename:n}=x.useContext(st),r=x.useContext(lt);E(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...Tt(e||`.`,{relative:t})},o=vt();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Fe([n,a.pathname])),oe(a)}function Gn(e,{relative:t}={}){let n=x.useContext(it);E(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=zn(`useViewTransitionState`),i=Tt(e,{relative:t});if(!n.isTransitioning)return!1;let a=De(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=De(n.nextLocation.pathname,r)||n.nextLocation.pathname;return Ce(i.pathname,o)!=null||Ce(i.pathname,a)!=null}var Kn=c(g(),1),qn=`https://script.google.com/macros/s/AKfycbwx7xa55DHx05GoXdX9G5lsEO4xQYwrIPNcU_yPz3Mf0GpiteHqsUdYKl2AEjVFk2jKBg/exec`;async function j(e,t={}){try{return await(await fetch(qn,{method:`POST`,headers:{"Content-Type":`text/plain;charset=utf-8`},body:JSON.stringify({action:e,...t})})).json()}catch(t){return console.error(`API error [${e}]:`,t),{success:!1,message:`Unable to connect to server.`}}}async function Jn(e,t){return j(`login`,{email:e,password:t})}async function Yn(e){return j(`getUsers`,{currentUserId:e})}async function Xn(e,t){return j(`addUser`,{currentUserId:e,name:t.name,email:t.email,password:t.password,role:t.role,login:t.login})}async function Zn(e,t){return j(`updateUser`,{currentUserId:e,id:t.id,name:t.name,email:t.email,password:t.password,role:t.role,login:t.login})}async function Qn(e,t){return j(`deleteUser`,{currentUserId:e,id:t})}async function $n(e,t){return j(`getPermissions`,{currentUserId:e,userId:t})}async function er(e,t,n){return j(`updatePermissions`,{currentUserId:e,userId:t,viewCollections:n.viewCollections===!0,addCollection:n.addCollection===!0,editCollection:n.editCollection===!0,deleteCollection:n.deleteCollection===!0,reports:n.reports===!0,settings:n.settings===!0,userManagement:n.userManagement===!0,transactions:n.transactions===!0,addTransaction:n.addTransaction===!0,editTransaction:n.editTransaction===!0,deleteTransaction:n.deleteTransaction===!0})}async function tr(e){return j(`getCollections`,{currentUserId:e})}async function nr(e,t){return j(`addCollection`,{currentUserId:e,rno:t.rno,name:t.name,place:t.place,amount:t.amount,status:t.status})}async function rr(e,t){return j(`updateCollection`,{currentUserId:e,originalRno:t.originalRno,rno:t.rno,name:t.name,place:t.place,amount:t.amount,status:t.status})}async function ir(e,t){return j(`deleteCollection`,{currentUserId:e,rno:t})}async function ar(){return j(`publicCollections`)}async function or(e){return j(`getPlaces`,{currentUserId:e})}async function sr(e,t){return j(`addPlace`,{currentUserId:e,place:t})}async function cr(e,t){return j(`deletePlace`,{currentUserId:e,place:t})}async function lr(e){return j(`getNotice`,{currentUserId:e})}async function ur(e,t){return j(`updateNotice`,{currentUserId:e,notice:t})}async function dr(e){return j(`getTransactions`,{currentUserId:e})}async function fr(e,t){return j(`addTransaction`,{currentUserId:e,type:t.type,description:t.description,amount:t.amount,fromTo:t.fromTo})}async function pr(e,t){return j(`editTransaction`,{currentUserId:e,id:t.id,type:t.type,description:t.description,amount:t.amount,fromTo:t.fromTo})}async function mr(e,t){return j(`deleteTransaction`,{currentUserId:e,id:t})}var hr=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),M=o(((e,t)=>{t.exports=hr()}))(),gr=(0,x.createContext)();function _r({children:e}){let[t,n]=(0,x.useState)(null),[r,i]=(0,x.useState)(!0);(0,x.useEffect)(()=>{try{let e=localStorage.getItem(`durgaPujaUser`);if(e){let t=JSON.parse(e);n(t)}}catch(e){console.error(`Unable to restore login:`,e),localStorage.removeItem(`durgaPujaUser`)}finally{i(!1)}},[]);let a={user:t,loading:r,login:async(e,t)=>{i(!0);try{let r=await Jn(e,t);if(!r.success)return r;let i={...r.user,permissions:r.user.permissions||{}};return n(i),localStorage.setItem(`durgaPujaUser`,JSON.stringify(i)),{success:!0}}catch(e){return console.error(`Login error:`,e),{success:!1,message:`Unable to connect to server.`}}finally{i(!1)}},logout:()=>{n(null),localStorage.removeItem(`durgaPujaUser`)},updateLoggedInUser:e=>{n(t=>{if(!t)return t;let n={...t,...e};return localStorage.setItem(`durgaPujaUser`,JSON.stringify(n)),n})},hasPermission:e=>t?t.permissions?.[e]===!0:!1};return(0,M.jsx)(gr.Provider,{value:a,children:e})}function vr(){return(0,x.useContext)(gr)}function yr(){let{user:e,loading:t}=vr();return t?(0,M.jsxs)(`div`,{className:`app-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading...`})]}):e?(0,M.jsx)(qt,{}):(0,M.jsx)(Kt,{to:`/login`,replace:!0})}function br({permission:e}){let{user:t,loading:n}=vr();return n?(0,M.jsxs)(`div`,{className:`app-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading...`})]}):t?(t.permissions||{})[e]===!0?(0,M.jsx)(qt,{}):(0,M.jsx)(Kt,{to:`/`,replace:!0}):(0,M.jsx)(Kt,{to:`/login`,replace:!0})}function xr(){let{user:e,loading:t}=vr();return t?(0,M.jsxs)(`div`,{className:`app-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading...`})]}):e?String(e.role).toLowerCase()===`admin`?(0,M.jsx)(qt,{}):(0,M.jsx)(Kt,{to:`/`,replace:!0}):(0,M.jsx)(Kt,{to:`/login`,replace:!0})}function Sr({onMenuClick:e}){let{user:t,logout:n}=vr(),r=xt();return(0,M.jsxs)(`header`,{className:`top-navbar`,children:[(0,M.jsxs)(`div`,{className:`navbar-left`,children:[(0,M.jsx)(`button`,{className:`menu-button`,onClick:e,"aria-label":`Open menu`,children:`☰`}),(0,M.jsxs)(`div`,{className:`navbar-brand`,onClick:()=>r(`/`),children:[(0,M.jsx)(`span`,{className:`navbar-icon`,children:`🪔`}),(0,M.jsx)(`span`,{children:`Durga Puja Collection`})]})]}),(0,M.jsxs)(`div`,{className:`navbar-right`,children:[(0,M.jsxs)(`button`,{className:`profile-button`,onClick:()=>r(`/profile`),children:[(0,M.jsx)(`span`,{className:`profile-mini-avatar`,children:t?.name?t.name.charAt(0).toUpperCase():`U`}),(0,M.jsx)(`span`,{className:`profile-name`,children:t?.name||`User`})]}),(0,M.jsx)(`button`,{className:`logout-button`,onClick:()=>{n(),r(`/login`,{replace:!0})},title:`Logout`,children:`Logout`})]})]})}function Cr({open:e,onClose:t}){let{user:n,hasPermission:r}=vr(),i=()=>{t&&t()};return(0,M.jsxs)(M.Fragment,{children:[e&&(0,M.jsx)(`div`,{className:`sidebar-overlay`,onClick:i}),(0,M.jsxs)(`aside`,{className:`sidebar ${e?`sidebar-open`:``}`,children:[(0,M.jsxs)(`div`,{className:`sidebar-header`,children:[(0,M.jsx)(`div`,{className:`sidebar-logo`,children:`🪔`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:`Durga Puja`}),(0,M.jsx)(`small`,{children:`Collection`})]}),(0,M.jsx)(`button`,{className:`sidebar-close`,onClick:i,"aria-label":`Close menu`,children:`×`})]}),(0,M.jsxs)(`nav`,{className:`sidebar-nav`,children:[(0,M.jsxs)(In,{to:`/`,end:!0,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`🏠`}),(0,M.jsx)(`span`,{children:`Dashboard`})]}),r(`viewCollections`)&&(0,M.jsxs)(In,{to:`/collections`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`💰`}),(0,M.jsx)(`span`,{children:`Collections`})]}),r(`reports`)&&(0,M.jsxs)(In,{to:`/reports`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`📊`}),(0,M.jsx)(`span`,{children:`Reports`})]}),r(`transactions`)&&(0,M.jsxs)(In,{to:`/transactions`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`💳`}),(0,M.jsx)(`span`,{children:`Transactions`})]}),r(`settings`)&&(0,M.jsxs)(In,{to:`/settings`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`⚙️`}),(0,M.jsx)(`span`,{children:`Settings`})]}),String(n?.role).toLowerCase()===`admin`&&r(`userManagement`)&&(0,M.jsxs)(In,{to:`/admin/users`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`👥`}),(0,M.jsx)(`span`,{children:`User Management`})]})]}),(0,M.jsxs)(`div`,{className:`sidebar-bottom`,children:[(0,M.jsxs)(In,{to:`/profile`,onClick:i,className:({isActive:e})=>`sidebar-link ${e?`active`:``}`,children:[(0,M.jsx)(`span`,{children:`👤`}),(0,M.jsx)(`span`,{children:`Profile`})]}),(0,M.jsxs)(`div`,{className:`sidebar-user`,children:[(0,M.jsx)(`div`,{className:`profile-mini-avatar`,children:n?.name?n.name.charAt(0).toUpperCase():`U`}),(0,M.jsxs)(`div`,{className:`sidebar-user-info`,children:[(0,M.jsx)(`strong`,{children:n?.name||`User`}),(0,M.jsx)(`small`,{children:String(n?.role||`user`).toUpperCase()})]})]})]})]})]})}function wr(){let{user:e,login:t,loading:n}=vr(),r=xt(),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(``),[c,l]=(0,x.useState)(``),[u,d]=(0,x.useState)(!1);return e?(0,M.jsx)(Kt,{to:`/`,replace:!0}):(0,M.jsxs)(`div`,{className:`login-page`,children:[(0,M.jsxs)(`div`,{className:`login-card`,children:[(0,M.jsxs)(`div`,{className:`login-header`,children:[(0,M.jsx)(`div`,{className:`login-logo`,children:`🪔`}),(0,M.jsx)(`h1`,{children:`Durga Puja Collection`}),(0,M.jsx)(`p`,{children:`Sign in to continue`})]}),(0,M.jsxs)(`form`,{onSubmit:async e=>{if(e.preventDefault(),l(``),!i.trim()){l(`Please enter your email.`);return}if(!o){l(`Please enter your password.`);return}d(!0);let n=await t(i.trim(),o);if(d(!1),!n.success){l(n.message||`Login failed.`);return}r(`/`,{replace:!0})},className:`login-form`,children:[(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{htmlFor:`email`,children:`Email`}),(0,M.jsx)(`input`,{id:`email`,type:`email`,value:i,onChange:e=>a(e.target.value),placeholder:`Enter your email`,autoComplete:`username`,disabled:u})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{htmlFor:`password`,children:`Password`}),(0,M.jsx)(`input`,{id:`password`,type:`password`,value:o,onChange:e=>s(e.target.value),placeholder:`Enter your password`,autoComplete:`current-password`,disabled:u})]}),c&&(0,M.jsx)(`div`,{className:`login-error`,children:c}),(0,M.jsx)(`button`,{type:`submit`,className:`login-button`,disabled:u||n,children:u?(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`span`,{className:`button-spinner`}),`Signing in...`]}):`Sign In`})]}),(0,M.jsxs)(`div`,{className:`public-collection-section`,children:[(0,M.jsx)(`div`,{className:`public-collection-icon`,children:`🔎`}),(0,M.jsxs)(`div`,{className:`public-collection-content`,children:[(0,M.jsx)(`h2`,{children:`Check Your Collection`}),(0,M.jsx)(`p`,{children:`No login required`}),(0,M.jsx)(`span`,{children:`View your Durga Puja collection status directly without signing in.`})]}),(0,M.jsxs)(`a`,{href:`/public-collections`,className:`public-collection-button`,children:[(0,M.jsx)(`span`,{children:`View Collection`}),(0,M.jsx)(`span`,{className:`public-arrow`,children:`→`})]}),(0,M.jsx)(`div`,{className:`public-link-note`,children:`Public access • No account required`})]})]}),(0,M.jsx)(`style`,{children:`
        ...
        .public-collection-content span {
          display: block;
          color: #6b7280;
          font-size: 12px;
          line-height: 1.5;
        ...
        .public-collection-button:hover {
          background: #4338ca;
          color: #ffffff;
        ...
        .public-collection-button:active {
      ...
      `})]})}function Tr(){let e=xt(),[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(!0),[s,c]=(0,x.useState)(``);(0,x.useEffect)(()=>{let e=!0;async function t(){o(!0),c(``);let t=await ar();e&&(t.success?n(t.collections||[]):c(t.message||`Unable to load collection updates.`),o(!1))}return t(),()=>{e=!1}},[]);let l=r.trim().toLowerCase(),u=t.filter(e=>!l||[e.rno,e.name,e.place,e.amount,e.status].join(` `).toLowerCase().includes(l));return(0,M.jsxs)(`div`,{className:`public-page`,children:[(0,M.jsxs)(`div`,{className:`public-container`,children:[(0,M.jsxs)(`div`,{className:`public-header`,children:[(0,M.jsx)(`button`,{className:`public-back-button`,onClick:()=>e(`/login`),children:`← Back to Login`}),(0,M.jsx)(`div`,{className:`public-logo`,children:`🪔`}),(0,M.jsx)(`h1`,{children:`Collection Updates`}),(0,M.jsx)(`p`,{children:`Check your Durga Puja collection status without logging in.`})]}),(0,M.jsxs)(`div`,{className:`public-search-box`,children:[(0,M.jsx)(`span`,{children:`🔎`}),(0,M.jsx)(`input`,{type:`search`,value:r,onChange:e=>i(e.target.value),placeholder:`Search by R.No, name or place...`})]}),(0,M.jsxs)(`div`,{className:`public-info`,children:[(0,M.jsx)(`span`,{children:`✓`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:`Collection status`}),(0,M.jsx)(`small`,{children:`Check whether your collection is marked as PAID or UNPAID.`})]})]}),a&&(0,M.jsxs)(`div`,{className:`public-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading collection updates...`})]}),!a&&s&&(0,M.jsx)(`div`,{className:`public-error`,children:s}),!a&&!s&&(0,M.jsx)(`div`,{className:`public-desktop-table`,children:(0,M.jsx)(`div`,{className:`public-table-card`,children:(0,M.jsxs)(`table`,{children:[(0,M.jsx)(`thead`,{children:(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`th`,{children:`R.No`}),(0,M.jsx)(`th`,{children:`Name`}),(0,M.jsx)(`th`,{children:`Place`}),(0,M.jsx)(`th`,{children:`Amount`}),(0,M.jsx)(`th`,{children:`Status`})]})}),(0,M.jsx)(`tbody`,{children:u.length===0?(0,M.jsx)(`tr`,{children:(0,M.jsx)(`td`,{colSpan:`5`,className:`empty-table`,children:`No collection found.`})}):u.map(e=>(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`td`,{children:e.rno}),(0,M.jsx)(`td`,{children:e.name}),(0,M.jsx)(`td`,{children:e.place}),(0,M.jsxs)(`td`,{children:[`₹`,Number(e.amount||0).toLocaleString(`en-IN`)]}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:String(e.status).toUpperCase()===`PAID`?`status-paid`:`status-unpaid`,children:String(e.status).toUpperCase()})})]},e.rno))})]})})}),!a&&!s&&(0,M.jsx)(`div`,{className:`public-mobile-list`,children:u.length===0?(0,M.jsxs)(`div`,{className:`public-empty`,children:[(0,M.jsx)(`div`,{children:`🔍`}),(0,M.jsx)(`strong`,{children:`No collection found`}),(0,M.jsx)(`span`,{children:`Try another name, R.No or place.`})]}):u.map(e=>{let t=String(e.status).toUpperCase()===`PAID`;return(0,M.jsxs)(`div`,{className:`public-collection-card`,children:[(0,M.jsxs)(`div`,{className:`public-card-top`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`span`,{className:`public-rno`,children:[`R.No `,e.rno]}),(0,M.jsx)(`strong`,{children:e.name})]}),(0,M.jsx)(`span`,{className:t?`status-paid`:`status-unpaid`,children:t?`PAID`:`UNPAID`})]}),(0,M.jsxs)(`div`,{className:`public-card-details`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`small`,{children:`Place`}),(0,M.jsx)(`span`,{children:e.place})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`small`,{children:`Amount`}),(0,M.jsxs)(`strong`,{children:[`₹`,Number(e.amount||0).toLocaleString(`en-IN`)]})]})]})]},e.rno)})}),!a&&!s&&u.length>0&&(0,M.jsxs)(`div`,{className:`public-count`,children:[`Showing`,` `,u.length,` `,`of`,` `,t.length,` `,`collection`,t.length===1?``:`s`]})]}),(0,M.jsx)(`style`,{children:`
        ...
        .public-table-card th,
        .public-table-card td {
          padding: 13px 15px;
        ...
        .public-table-card tr:last-child td {
          border-bottom: none;
        }
      ...
      `})]})}function Er(){let{user:e}=vr(),[t,n]=(0,x.useState)(``),[r,i]=(0,x.useState)(!0);return(0,x.useEffect)(()=>{let t=!0;async function r(){if(!e?.id){i(!1);return}i(!0);let r=await lr(e.id);t&&(r.success?n(r.notice||``):n(``),i(!1))}return r(),()=>{t=!1}},[e?.id]),(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`div`,{className:`page-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Dashboard`}),(0,M.jsxs)(`p`,{children:[`Welcome, `,e?.name||`User`]})]})}),(0,M.jsxs)(`div`,{className:`notice-card`,children:[(0,M.jsxs)(`div`,{className:`notice-title`,children:[(0,M.jsx)(`span`,{children:`📢`}),(0,M.jsx)(`h2`,{children:`Notice`})]}),r?(0,M.jsxs)(`div`,{className:`inline-loading`,children:[(0,M.jsx)(`span`,{className:`spinner`}),(0,M.jsx)(`span`,{children:`Loading notice...`})]}):t?(0,M.jsx)(`div`,{className:`notice-content`,children:t}):(0,M.jsx)(`div`,{className:`notice-empty`,children:`No notice available.`})]})]})}function Dr(){let{user:e,hasPermission:t}=vr(),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)([]),[o,s]=(0,x.useState)(!0),[c,l]=(0,x.useState)(!1),[u,d]=(0,x.useState)(!1),[f,p]=(0,x.useState)(null),[m,h]=(0,x.useState)(``),g={rno:``,name:``,place:``,amount:``,status:`UNPAID`},[_,v]=(0,x.useState)(g);(0,x.useEffect)(()=>{let t=!0;async function n(){s(!0);let[n,i]=await Promise.all([tr(e.id),or(e.id)]);t&&(n.success&&r(n.collections||[]),i.success&&a(i.places||[]),s(!1))}return n(),()=>{t=!1}},[e.id]);let y=(0,x.useMemo)(()=>{let e=0;return n.forEach(t=>{let n=Number(t.rno);Number.isInteger(n)&&(e=Math.max(e,n))}),e+1},[n]),b=(0,x.useMemo)(()=>{let e=m.trim().toLowerCase();return e?n.filter(t=>[t.rno,t.name,t.place,t.amount,t.status,t.user].join(` `).toLowerCase().includes(e)):n},[n,m]),S=()=>{p(null),v({...g,rno:String(y)}),d(!0)},C=e=>{p(e),v({rno:String(e.rno),name:e.name||``,place:e.place||``,amount:e.amount??``,status:String(e.status).toUpperCase()===`PAID`?`PAID`:`UNPAID`}),d(!0)},w=()=>{c||(d(!1),p(null),v({...g}))},T=e=>{let{name:t,value:n}=e.target;v(e=>({...e,[t]:n}))},ee=async t=>{if(t.preventDefault(),!_.rno.trim()){alert(`Please enter R.No.`);return}if(!_.name.trim()){alert(`Please enter name.`);return}if(!_.place.trim()){alert(`Please select a place.`);return}if(_.amount===``||Number(_.amount)<0){alert(`Please enter a valid amount.`);return}let n=Number(_.rno);if(!Number.isInteger(n)||n<=0){alert(`R.No must be a positive whole number.`);return}l(!0);let r;if(r=f?await rr(e.id,{originalRno:f.rno,rno:n,name:_.name.trim(),place:_.place.trim(),amount:Number(_.amount),status:_.status}):await nr(e.id,{rno:n,name:_.name.trim(),place:_.place.trim(),amount:Number(_.amount),status:_.status}),l(!1),!r.success){alert(r.message||`Unable to save collection.`);return}w(),await te()},te=async()=>{let t=await tr(e.id);t.success&&r(t.collections||[])},E=async t=>{if(!window.confirm(`Delete collection R.No ${t.rno}?`))return;l(!0);let n=await ir(e.id,t.rno);if(l(!1),!n.success){alert(n.message||`Unable to delete collection.`);return}r(e=>e.filter(e=>String(e.rno)!==String(t.rno)))};return o?(0,M.jsx)(`div`,{className:`page-container`,children:(0,M.jsxs)(`div`,{className:`page-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading collections...`})]})}):(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`style`,{children:`
        ...
        .collection-mobile-details {
          display: grid;
          grid-template-columns: 1fr 1fr;
          gap: 10px;
        }

        .collection-mobile-detail {
          min-width: 0;
        }

        .collection-mobile-label {
          display: block;
          font-size: 11px;
          color: #9ca3af;
          margin-bottom: 3px;
        ...
        .collection-mobile-actions button {
          flex: 1;
          min-height: 38px;
        }
      ...
      `}),(0,M.jsxs)(`div`,{className:`page-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Collections`}),(0,M.jsx)(`p`,{children:`Manage Durga Puja collections`})]}),t(`addCollection`)&&(0,M.jsx)(`button`,{className:`primary-button`,onClick:S,children:`+ New Collection`})]}),(0,M.jsx)(`div`,{className:`collection-toolbar`,children:(0,M.jsx)(`input`,{type:`search`,value:m,onChange:e=>h(e.target.value),placeholder:`Search collections...`,className:`search-input`})}),(0,M.jsx)(`div`,{className:`table-card collections-desktop-table`,children:(0,M.jsx)(`div`,{className:`table-wrapper`,children:(0,M.jsxs)(`table`,{children:[(0,M.jsx)(`thead`,{children:(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`th`,{children:`R.No`}),(0,M.jsx)(`th`,{children:`Name`}),(0,M.jsx)(`th`,{children:`Place`}),(0,M.jsx)(`th`,{children:`Amount`}),(0,M.jsx)(`th`,{children:`Status`}),(0,M.jsx)(`th`,{children:`User`}),(t(`editCollection`)||t(`deleteCollection`))&&(0,M.jsx)(`th`,{children:`Action`})]})}),(0,M.jsx)(`tbody`,{children:b.length===0?(0,M.jsx)(`tr`,{children:(0,M.jsx)(`td`,{colSpan:t(`editCollection`)||t(`deleteCollection`)?7:6,className:`empty-table`,children:`No collections found.`})}):b.map(e=>(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`td`,{children:e.rno}),(0,M.jsx)(`td`,{children:e.name}),(0,M.jsx)(`td`,{children:e.place}),(0,M.jsxs)(`td`,{children:[`₹`,Number(e.amount||0).toLocaleString(`en-IN`)]}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:e.status===`PAID`?`status-paid`:`status-unpaid`,children:e.status})}),(0,M.jsx)(`td`,{children:e.user}),(t(`editCollection`)||t(`deleteCollection`))&&(0,M.jsx)(`td`,{children:(0,M.jsxs)(`div`,{className:`table-actions`,children:[t(`editCollection`)&&(0,M.jsx)(`button`,{className:`small-button`,onClick:()=>C(e),disabled:c,children:`Edit`}),t(`deleteCollection`)&&(0,M.jsx)(`button`,{className:`small-button danger-button`,onClick:()=>E(e),disabled:c,children:`Delete`})]})})]},e.rno))})]})})}),(0,M.jsxs)(`div`,{className:`collections-mobile-list`,children:[b.length===0?(0,M.jsx)(`div`,{className:`table-card`,children:(0,M.jsx)(`div`,{className:`empty-table`,children:`No collections found.`})}):b.map(e=>(0,M.jsxs)(`div`,{className:`collection-mobile-card`,children:[(0,M.jsxs)(`div`,{className:`collection-mobile-top`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`div`,{className:`collection-mobile-rno`,children:[`R.No `,e.rno]}),(0,M.jsx)(`div`,{className:`collection-mobile-name`,children:e.name})]}),(0,M.jsx)(`span`,{className:e.status===`PAID`?`status-paid`:`status-unpaid`,children:e.status})]}),(0,M.jsxs)(`div`,{className:`collection-mobile-details`,children:[(0,M.jsxs)(`div`,{className:`collection-mobile-detail`,children:[(0,M.jsx)(`span`,{className:`collection-mobile-label`,children:`Place`}),(0,M.jsx)(`span`,{className:`collection-mobile-value`,children:e.place})]}),(0,M.jsxs)(`div`,{className:`collection-mobile-detail`,children:[(0,M.jsx)(`span`,{className:`collection-mobile-label`,children:`Amount`}),(0,M.jsxs)(`span`,{className:`collection-mobile-value collection-mobile-amount`,children:[`₹`,Number(e.amount||0).toLocaleString(`en-IN`)]})]}),(0,M.jsxs)(`div`,{className:`collection-mobile-detail`,children:[(0,M.jsx)(`span`,{className:`collection-mobile-label`,children:`User`}),(0,M.jsx)(`span`,{className:`collection-mobile-value`,children:e.user})]})]}),(t(`editCollection`)||t(`deleteCollection`))&&(0,M.jsxs)(`div`,{className:`collection-mobile-actions`,children:[t(`editCollection`)&&(0,M.jsx)(`button`,{className:`small-button`,onClick:()=>C(e),disabled:c,children:`Edit`}),t(`deleteCollection`)&&(0,M.jsx)(`button`,{className:`small-button danger-button`,onClick:()=>E(e),disabled:c,children:`Delete`})]})]},e.rno)),b.length>0&&(0,M.jsxs)(`div`,{className:`collections-count`,children:[`Showing `,b.length,` of`,` `,n.length,` collection`,n.length===1?``:`s`]})]}),u&&(0,M.jsx)(`div`,{className:`modal-overlay`,onMouseDown:e=>{e.target===e.currentTarget&&!c&&w()},children:(0,M.jsxs)(`div`,{className:`modal-card`,children:[(0,M.jsxs)(`div`,{className:`modal-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:f?`Edit Collection`:`New Collection`}),(0,M.jsx)(`p`,{children:`Enter collection details`})]}),(0,M.jsx)(`button`,{className:`modal-close`,onClick:w,disabled:c,children:`×`})]}),(0,M.jsxs)(`form`,{onSubmit:ee,className:`collection-form`,children:[(0,M.jsxs)(`div`,{className:`form-grid`,children:[(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{children:`R.No`}),(0,M.jsx)(`input`,{type:`number`,name:`rno`,min:`1`,step:`1`,value:_.rno,onChange:T,disabled:c}),!f&&(0,M.jsxs)(`small`,{children:[`Suggested: `,y]})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{children:`Name`}),(0,M.jsx)(`input`,{type:`text`,name:`name`,value:_.name,onChange:T,placeholder:`Enter name`,disabled:c})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{children:`Place`}),(0,M.jsxs)(`select`,{name:`place`,value:_.place,onChange:T,disabled:c,children:[(0,M.jsx)(`option`,{value:``,children:`Select place`}),i.map(e=>(0,M.jsx)(`option`,{value:e,children:e},e))]})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{children:`Amount`}),(0,M.jsx)(`input`,{type:`number`,name:`amount`,min:`0`,step:`0.01`,value:_.amount,onChange:T,placeholder:`Enter amount`,disabled:c})]}),(0,M.jsxs)(`div`,{className:`form-group`,children:[(0,M.jsx)(`label`,{children:`Status`}),(0,M.jsxs)(`select`,{name:`status`,value:_.status,onChange:T,disabled:c,children:[(0,M.jsx)(`option`,{value:`UNPAID`,children:`UNPAID`}),(0,M.jsx)(`option`,{value:`PAID`,children:`PAID`})]})]})]}),(0,M.jsxs)(`div`,{className:`modal-footer`,children:[(0,M.jsx)(`button`,{type:`button`,className:`secondary-button`,onClick:w,disabled:c,children:`Cancel`}),(0,M.jsx)(`button`,{type:`submit`,className:`primary-button`,disabled:c,children:c?(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`span`,{className:`button-spinner`}),`Saving...`]}):f?`Update Collection`:`Save Collection`})]})]})]})})]})}function Or(){let{user:e,hasPermission:t}=vr(),[n,r]=(0,x.useState)([]),[i,a]=(0,x.useState)([]),[o,s]=(0,x.useState)(!0),c=t(`transactions`);(0,x.useEffect)(()=>{let t=!0;async function n(){s(!0);let n=await tr(e.id);if(t){if(n.success&&r(n.collections||[]),c){let n=await dr(e.id);if(!t)return;n.success?a(n.transactions||[]):a([])}else a([]);s(!1)}}return n(),()=>{t=!1}},[e.id,c]);let l=(0,x.useMemo)(()=>{let e=0,t=0,r=0,i=0;return n.forEach(n=>{let a=Number(n.amount)||0;String(n.status).toUpperCase()===`PAID`?(e+=a,r++):(t+=a,i++)}),{totalCollected:e,unpaidAmount:t,totalRecords:n.length,paidCount:r,unpaidCount:i}},[n]),u=(0,x.useMemo)(()=>{let e=0,t=0,n=0;return i.forEach(r=>{let i=Number(r.amount)||0,a=String(r.type).toUpperCase();a===`INCOME`&&(e+=i),a===`PURCHASE`&&(t+=i),a===`TRANSFER`&&(n+=i)}),{income:e,purchase:t,transfer:n,total:i.length}},[i]),d=l.totalCollected+u.income-u.purchase;return o?(0,M.jsx)(`div`,{className:`page-container`,children:(0,M.jsxs)(`div`,{className:`page-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading reports...`})]})}):(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`div`,{className:`page-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Reports`}),(0,M.jsx)(`p`,{children:`Collection and transaction summary`})]})}),(0,M.jsx)(`h2`,{className:`report-section-title`,children:`Collection Summary`}),(0,M.jsxs)(`div`,{className:`report-grid`,children:[(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Total Collected`}),(0,M.jsxs)(`strong`,{children:[`₹`,l.totalCollected.toLocaleString(`en-IN`)]}),(0,M.jsxs)(`small`,{children:[l.paidCount,` paid record`,l.paidCount===1?``:`s`]})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Unpaid Amount`}),(0,M.jsxs)(`strong`,{children:[`₹`,l.unpaidAmount.toLocaleString(`en-IN`)]}),(0,M.jsxs)(`small`,{children:[l.unpaidCount,` unpaid record`,l.unpaidCount===1?``:`s`]})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Total Records`}),(0,M.jsx)(`strong`,{children:l.totalRecords}),(0,M.jsx)(`small`,{children:`All collections`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Paid Records`}),(0,M.jsx)(`strong`,{children:l.paidCount}),(0,M.jsx)(`small`,{children:`Collections marked as PAID`})]})]}),(0,M.jsx)(`div`,{className:`table-card`,children:(0,M.jsxs)(`div`,{className:`report-summary`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`b`,{children:`Paid Records`}),(0,M.jsx)(`span`,{children:l.paidCount})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`b`,{children:`Unpaid Records`}),(0,M.jsx)(`span`,{children:l.unpaidCount})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`b`,{children:`Total Records`}),(0,M.jsx)(`span`,{children:l.totalRecords})]})]})}),c&&(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`h2`,{className:`report-section-title`,children:`Transaction Summary`}),(0,M.jsxs)(`div`,{className:`report-grid`,children:[(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Other Income`}),(0,M.jsxs)(`strong`,{children:[`₹`,u.income.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`INCOME transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Total Spent`}),(0,M.jsxs)(`strong`,{children:[`₹`,u.purchase.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`PURCHASE transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Transfers`}),(0,M.jsxs)(`strong`,{children:[`₹`,u.transfer.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`TRANSFER transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Total Balance Left`}),(0,M.jsxs)(`strong`,{children:[`₹`,d.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`Collected + Income − Spent`})]})]}),(0,M.jsx)(`div`,{className:`transaction-desktop`,children:(0,M.jsxs)(`div`,{className:`table-card transaction-table-card`,children:[(0,M.jsx)(`div`,{className:`report-table-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Transactions`}),(0,M.jsxs)(`span`,{children:[i.length,` transaction`,i.length===1?``:`s`]})]})}),(0,M.jsx)(`div`,{className:`table-responsive`,children:(0,M.jsxs)(`table`,{children:[(0,M.jsx)(`thead`,{children:(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`th`,{children:`ID`}),(0,M.jsx)(`th`,{children:`Date`}),(0,M.jsx)(`th`,{children:`Type`}),(0,M.jsx)(`th`,{children:`Description`}),(0,M.jsx)(`th`,{children:`Amount`}),(0,M.jsx)(`th`,{children:`From / To`})]})}),(0,M.jsx)(`tbody`,{children:i.length===0?(0,M.jsx)(`tr`,{children:(0,M.jsx)(`td`,{colSpan:`6`,className:`transaction-empty`,children:`No transactions found.`})}):i.map(e=>(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`td`,{children:e.id}),(0,M.jsx)(`td`,{children:e.dateTime?new Date(e.dateTime).toLocaleString(`en-IN`):``}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:`transaction-type ${String(e.type).toLowerCase()}`,children:e.type})}),(0,M.jsx)(`td`,{children:e.description}),(0,M.jsxs)(`td`,{className:`transaction-amount`,children:[`₹`,Number(e.amount).toLocaleString(`en-IN`)]}),(0,M.jsx)(`td`,{children:e.fromTo||`-`})]},e.id))})]})})]})}),(0,M.jsxs)(`div`,{className:`transaction-mobile`,children:[(0,M.jsx)(`div`,{className:`mobile-transaction-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Transactions`}),(0,M.jsxs)(`span`,{children:[i.length,` transaction`,i.length===1?``:`s`]})]})}),i.length===0?(0,M.jsxs)(`div`,{className:`mobile-empty-transaction`,children:[(0,M.jsx)(`div`,{className:`empty-icon`,children:`💳`}),(0,M.jsx)(`strong`,{children:`No transactions`}),(0,M.jsx)(`span`,{children:`Transactions will appear here.`})]}):(0,M.jsx)(`div`,{className:`mobile-transaction-list`,children:i.map(e=>(0,M.jsxs)(`div`,{className:`mobile-transaction-card`,children:[(0,M.jsxs)(`div`,{className:`mobile-transaction-top`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`span`,{className:`mobile-transaction-id`,children:[`Transaction #`,e.id]}),(0,M.jsx)(`strong`,{children:e.description})]}),(0,M.jsx)(`span`,{className:`transaction-type ${String(e.type).toLowerCase()}`,children:e.type})]}),(0,M.jsxs)(`div`,{className:`mobile-transaction-amount`,children:[`₹`,Number(e.amount).toLocaleString(`en-IN`)]}),(0,M.jsxs)(`div`,{className:`mobile-transaction-details`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Date`}),(0,M.jsx)(`strong`,{children:e.dateTime?new Date(e.dateTime).toLocaleString(`en-IN`):`-`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`From / To`}),(0,M.jsx)(`strong`,{children:e.fromTo||`-`})]})]})]},e.id))})]})]}),(0,M.jsx)(`style`,{children:`
        ...
        .mobile-transaction-header h3 {
          margin: 0;
          font-size: 16px;
        }


        .mobile-transaction-header span {
          display: block;
          margin-top: 3px;
          color: #777;
          font-size: 12px;
        ...
        .mobile-transaction-details div {
          min-width: 0;
        }


        .mobile-transaction-details span {
          display: block;
          font-size: 10px;
          color: #888;
          margin-bottom: 3px;
        ...
        .mobile-transaction-details strong {
          display: block;
          font-size: 12px;
          font-weight: 600;
          word-break: break-word;
        ...
        .mobile-empty-transaction strong {
          font-size: 15px;
        }


        .mobile-empty-transaction span {
          margin-top: 4px;
          color: #888;
          font-size: 12px;
        }
      ...
      `})]})}function kr(){let{user:e}=vr(),t=e?.permissions||{},n=t.addTransaction===!0,r=t.editTransaction===!0,i=t.deleteTransaction===!0,[a,o]=(0,x.useState)([]),[s,c]=(0,x.useState)(!0),[l,u]=(0,x.useState)(!1),[d,f]=(0,x.useState)(!1),[p,m]=(0,x.useState)(null),[h,g]=(0,x.useState)({type:`PURCHASE`,description:``,amount:``,fromTo:``});async function _(){c(!0);let t=await dr(e.id);t.success?o(t.transactions||[]):alert(t.message||`Unable to load transactions.`),c(!1)}(0,x.useEffect)(()=>{_()},[e.id]);let v=(0,x.useMemo)(()=>{let e=0,t=0,n=0;return a.forEach(r=>{let i=Number(r.amount)||0,a=String(r.type).toUpperCase();a===`PURCHASE`&&(e+=i),a===`INCOME`&&(t+=i),a===`TRANSFER`&&(n+=i)}),{purchase:e,income:t,transfer:n}},[a]);function y(){m(null),g({type:`PURCHASE`,description:``,amount:``,fromTo:``}),f(!0)}function b(e){m(e),g({type:e.type||`PURCHASE`,description:e.description||``,amount:e.amount||``,fromTo:e.fromTo||``}),f(!0)}function S(){l||(f(!1),m(null))}function C(e){let{name:t,value:n}=e.target;g(e=>({...e,[t]:n}))}async function w(t){if(t.preventDefault(),!h.description.trim()){alert(`Please enter description.`);return}if(!h.amount||Number(h.amount)<=0){alert(`Please enter a valid amount.`);return}u(!0);let n;if(n=p?await pr(e.id,{id:p.id,type:h.type,description:h.description.trim(),amount:Number(h.amount),fromTo:h.fromTo.trim()}):await fr(e.id,{type:h.type,description:h.description.trim(),amount:Number(h.amount),fromTo:h.fromTo.trim()}),u(!1),!n.success){alert(n.message||`Unable to save transaction.`);return}f(!1),m(null),await _()}async function T(t){if(!window.confirm(`Delete this transaction?`))return;let n=await mr(e.id,t);if(!n.success){alert(n.message||`Unable to delete transaction.`);return}await _()}return s?(0,M.jsx)(`div`,{className:`page-container`,children:(0,M.jsxs)(`div`,{className:`page-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading transactions...`})]})}):(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsxs)(`div`,{className:`page-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Transactions`}),(0,M.jsx)(`p`,{children:`Manage income, purchases and transfers`})]}),n&&(0,M.jsx)(`button`,{className:`primary-btn transaction-add-btn`,onClick:y,children:`+ Add Transaction`})]}),(0,M.jsxs)(`div`,{className:`report-grid`,children:[(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Other Income`}),(0,M.jsxs)(`strong`,{children:[`₹`,v.income.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`INCOME transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Total Spent`}),(0,M.jsxs)(`strong`,{children:[`₹`,v.purchase.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`PURCHASE transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Transfers`}),(0,M.jsxs)(`strong`,{children:[`₹`,v.transfer.toLocaleString(`en-IN`)]}),(0,M.jsx)(`small`,{children:`TRANSFER transactions`})]}),(0,M.jsxs)(`div`,{className:`report-card`,children:[(0,M.jsx)(`span`,{children:`Transactions`}),(0,M.jsx)(`strong`,{children:a.length}),(0,M.jsx)(`small`,{children:`All transactions`})]})]}),(0,M.jsx)(`div`,{className:`transaction-desktop`,children:(0,M.jsxs)(`div`,{className:`table-card`,children:[(0,M.jsx)(`div`,{className:`report-table-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Transactions`}),(0,M.jsxs)(`span`,{children:[a.length,` transaction`,a.length===1?``:`s`]})]})}),(0,M.jsx)(`div`,{className:`table-responsive`,children:(0,M.jsxs)(`table`,{children:[(0,M.jsx)(`thead`,{children:(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`th`,{children:`ID`}),(0,M.jsx)(`th`,{children:`Date`}),(0,M.jsx)(`th`,{children:`Type`}),(0,M.jsx)(`th`,{children:`Description`}),(0,M.jsx)(`th`,{children:`Amount`}),(0,M.jsx)(`th`,{children:`From / To`}),(r||i)&&(0,M.jsx)(`th`,{children:`Action`})]})}),(0,M.jsx)(`tbody`,{children:a.length===0?(0,M.jsx)(`tr`,{children:(0,M.jsx)(`td`,{colSpan:r||i?7:6,className:`transaction-empty`,children:`No transactions found.`})}):a.map(e=>(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`td`,{children:e.id}),(0,M.jsx)(`td`,{children:e.dateTime?new Date(e.dateTime).toLocaleString(`en-IN`):``}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:`transaction-type ${String(e.type).toLowerCase()}`,children:e.type})}),(0,M.jsx)(`td`,{children:e.description}),(0,M.jsxs)(`td`,{className:`transaction-amount`,children:[`₹`,Number(e.amount).toLocaleString(`en-IN`)]}),(0,M.jsx)(`td`,{children:e.fromTo||`-`}),(r||i)&&(0,M.jsx)(`td`,{children:(0,M.jsxs)(`div`,{className:`transaction-actions`,children:[r&&(0,M.jsx)(`button`,{className:`transaction-edit-btn`,onClick:()=>b(e),children:`Edit`}),i&&(0,M.jsx)(`button`,{className:`transaction-delete-btn`,onClick:()=>T(e.id),children:`Delete`})]})})]},e.id))})]})})]})}),(0,M.jsxs)(`div`,{className:`transaction-mobile`,children:[(0,M.jsx)(`div`,{className:`mobile-transaction-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Transactions`}),(0,M.jsxs)(`span`,{children:[a.length,` transaction`,a.length===1?``:`s`]})]})}),a.length===0?(0,M.jsxs)(`div`,{className:`mobile-empty-transaction`,children:[(0,M.jsx)(`div`,{className:`empty-icon`,children:`💳`}),(0,M.jsx)(`strong`,{children:`No transactions`}),(0,M.jsx)(`span`,{children:`Transactions will appear here.`})]}):(0,M.jsx)(`div`,{className:`mobile-transaction-list`,children:a.map(e=>(0,M.jsxs)(`div`,{className:`mobile-transaction-card`,children:[(0,M.jsxs)(`div`,{className:`mobile-transaction-top`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`span`,{className:`mobile-transaction-id`,children:[`Transaction #`,e.id]}),(0,M.jsx)(`strong`,{children:e.description})]}),(0,M.jsx)(`span`,{className:`transaction-type ${String(e.type).toLowerCase()}`,children:e.type})]}),(0,M.jsxs)(`div`,{className:`mobile-transaction-amount`,children:[`₹`,Number(e.amount).toLocaleString(`en-IN`)]}),(0,M.jsxs)(`div`,{className:`mobile-transaction-details`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Date`}),(0,M.jsx)(`strong`,{children:e.dateTime?new Date(e.dateTime).toLocaleString(`en-IN`):`-`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`From / To`}),(0,M.jsx)(`strong`,{children:e.fromTo||`-`})]})]}),(r||i)&&(0,M.jsxs)(`div`,{className:`mobile-transaction-actions`,children:[r&&(0,M.jsx)(`button`,{className:`transaction-edit-btn`,onClick:()=>b(e),children:`Edit`}),i&&(0,M.jsx)(`button`,{className:`transaction-delete-btn`,onClick:()=>T(e.id),children:`Delete`})]})]},e.id))})]}),d&&(0,M.jsx)(`div`,{className:`transaction-modal-overlay`,onMouseDown:e=>{e.target===e.currentTarget&&S()},children:(0,M.jsxs)(`div`,{className:`transaction-modal`,children:[(0,M.jsxs)(`div`,{className:`transaction-modal-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{className:`transaction-modal-icon`,children:`💳`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:p?`Edit Transaction`:`New Transaction`}),(0,M.jsx)(`p`,{children:p?`Update transaction details`:`Enter transaction details`})]})]}),(0,M.jsx)(`button`,{className:`transaction-modal-close`,onClick:S,disabled:l,"aria-label":`Close`,children:`×`})]}),(0,M.jsxs)(`form`,{onSubmit:w,className:`transaction-form`,children:[(0,M.jsxs)(`div`,{className:`transaction-form-group`,children:[(0,M.jsx)(`label`,{children:`Transaction Type`}),(0,M.jsxs)(`select`,{name:`type`,value:h.type,onChange:C,children:[(0,M.jsx)(`option`,{value:`PURCHASE`,children:`PURCHASE`}),(0,M.jsx)(`option`,{value:`TRANSFER`,children:`TRANSFER`}),(0,M.jsx)(`option`,{value:`INCOME`,children:`INCOME`})]})]}),(0,M.jsxs)(`div`,{className:`transaction-form-group`,children:[(0,M.jsx)(`label`,{children:`Description`}),(0,M.jsx)(`input`,{type:`text`,name:`description`,value:h.description,onChange:C,placeholder:`e.g. Purchase of decoration`,autoFocus:!0})]}),(0,M.jsxs)(`div`,{className:`transaction-form-group`,children:[(0,M.jsx)(`label`,{children:`Amount`}),(0,M.jsxs)(`div`,{className:`amount-input-wrapper`,children:[(0,M.jsx)(`span`,{children:`₹`}),(0,M.jsx)(`input`,{type:`number`,name:`amount`,value:h.amount,onChange:C,min:`0.01`,step:`0.01`,placeholder:`0.00`})]})]}),(0,M.jsxs)(`div`,{className:`transaction-form-group`,children:[(0,M.jsxs)(`label`,{children:[`From / To`,(0,M.jsx)(`small`,{children:`Optional`})]}),(0,M.jsx)(`input`,{type:`text`,name:`fromTo`,value:h.fromTo,onChange:C,placeholder:`e.g. Puja Committee`})]}),(0,M.jsxs)(`div`,{className:`transaction-modal-footer`,children:[(0,M.jsx)(`button`,{type:`button`,className:`transaction-cancel-btn`,onClick:S,disabled:l,children:`Cancel`}),(0,M.jsx)(`button`,{type:`submit`,className:`transaction-save-btn`,disabled:l,children:l?`Saving...`:p?`Update Transaction`:`Save Transaction`})]})]})]})}),(0,M.jsx)(`style`,{children:`
        ...
        .transaction-modal-header > div:first-child {
          display: flex;
          align-items: flex-start;
          gap: 11px;
        }
        ...
        .transaction-form-group label small {
          color: #999;
          font-size: 10px;
          font-weight: 400;
        }
        ...
        .transaction-cancel-btn:disabled,
        .transaction-save-btn:disabled,
        .transaction-modal-close:disabled {
          opacity: .55;
          cursor: not-allowed;
        }
        ...
        @media (max-width: 700px) {
          ...
          /* Hide desktop transaction table */
      ...
      `})]})}function Ar(){let{user:e}=vr(),[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(``),[s,c]=(0,x.useState)(!0),[l,u]=(0,x.useState)(!1),[d,f]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let t=!0;async function r(){c(!0);let[r,a]=await Promise.all([or(e.id),lr(e.id)]);t&&(r.success&&n(r.places||[]),a.success&&i(a.notice||``),c(!1))}return r(),()=>{t=!1}},[e.id]);let p=async()=>{u(!0);let t=await ur(e.id,r);if(u(!1),!t.success){alert(t.message||`Unable to update notice.`);return}alert(`Notice updated successfully.`)},m=async t=>{t.preventDefault();let r=a.trim();if(!r){alert(`Please enter a place name.`);return}f(!0);let i=await sr(e.id,r);if(f(!1),!i.success){alert(i.message||`Unable to add place.`);return}n(e=>[...e,r]),o(``)},h=async t=>{if(!window.confirm(`Delete "${t}"?`))return;let r=await cr(e.id,t);if(!r.success){alert(r.message||`Unable to delete place.`);return}n(e=>e.filter(e=>e.toLowerCase()!==t.toLowerCase()))};return s?(0,M.jsx)(`div`,{className:`page-container`,children:(0,M.jsxs)(`div`,{className:`page-loading`,children:[(0,M.jsx)(`div`,{className:`spinner`}),(0,M.jsx)(`p`,{children:`Loading settings...`})]})}):(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`div`,{className:`page-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Settings`}),(0,M.jsx)(`p`,{children:`Manage notice and collection places`})]})}),(0,M.jsxs)(`div`,{className:`settings-card`,children:[(0,M.jsx)(`div`,{className:`settings-card-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:`Notice`}),(0,M.jsx)(`p`,{children:`This notice will appear on everyone's dashboard.`})]})}),(0,M.jsx)(`textarea`,{value:r,onChange:e=>i(e.target.value),placeholder:`Enter dashboard notice...`,rows:`5`,disabled:l}),(0,M.jsx)(`div`,{className:`settings-actions`,children:(0,M.jsx)(`button`,{className:`primary-button`,onClick:p,disabled:l,children:l?(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`span`,{className:`button-spinner`}),`Saving...`]}):`Save Notice`})})]}),(0,M.jsxs)(`div`,{className:`settings-card`,children:[(0,M.jsx)(`div`,{className:`settings-card-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:`Places`}),(0,M.jsx)(`p`,{children:`Places available while entering collections.`})]})}),(0,M.jsxs)(`form`,{className:`add-place-form`,onSubmit:m,children:[(0,M.jsx)(`input`,{type:`text`,value:a,onChange:e=>o(e.target.value),placeholder:`Enter new place`,disabled:d}),(0,M.jsx)(`button`,{type:`submit`,className:`primary-button`,disabled:d,children:d?(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`span`,{className:`button-spinner`}),`Adding...`]}):`+ Add Place`})]}),(0,M.jsx)(`div`,{className:`places-list`,children:t.length===0?(0,M.jsx)(`div`,{className:`settings-empty`,children:`No places added.`}):t.map(e=>(0,M.jsxs)(`div`,{className:`place-item`,children:[(0,M.jsx)(`span`,{children:e}),(0,M.jsx)(`button`,{className:`small-button danger-button`,onClick:()=>h(e),children:`Delete`})]},e))})]})]})}function jr(){let{user:e}=vr();return e?(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`div`,{className:`page-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Profile`}),(0,M.jsx)(`p`,{children:`Your account information`})]})}),(0,M.jsxs)(`div`,{className:`profile-card`,children:[(0,M.jsx)(`div`,{className:`profile-avatar`,children:e.name?e.name.charAt(0).toUpperCase():`U`}),(0,M.jsxs)(`div`,{className:`profile-info`,children:[(0,M.jsxs)(`div`,{className:`profile-row`,children:[(0,M.jsx)(`span`,{children:`Name`}),(0,M.jsx)(`strong`,{children:e.name})]}),(0,M.jsxs)(`div`,{className:`profile-row`,children:[(0,M.jsx)(`span`,{children:`Email`}),(0,M.jsx)(`strong`,{children:e.email})]}),(0,M.jsxs)(`div`,{className:`profile-row`,children:[(0,M.jsx)(`span`,{children:`Role`}),(0,M.jsx)(`strong`,{children:String(e.role).toUpperCase()})]})]})]}),(0,M.jsxs)(`div`,{className:`profile-card`,children:[(0,M.jsx)(`h2`,{children:`Permissions`}),(0,M.jsxs)(`div`,{className:`permission-summary`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`View Collections`}),(0,M.jsx)(`strong`,{children:e.permissions?.viewCollections?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Add Collection`}),(0,M.jsx)(`strong`,{children:e.permissions?.addCollection?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Edit Collection`}),(0,M.jsx)(`strong`,{children:e.permissions?.editCollection?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Delete Collection`}),(0,M.jsx)(`strong`,{children:e.permissions?.deleteCollection?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Reports`}),(0,M.jsx)(`strong`,{children:e.permissions?.reports?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`Settings`}),(0,M.jsx)(`strong`,{children:e.permissions?.settings?`Allowed`:`Not allowed`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{children:`User Management`}),(0,M.jsx)(`strong`,{children:e.permissions?.userManagement?`Allowed`:`Not allowed`})]})]})]})]}):null}function Mr(){let{user:e}=vr(),t=xt();return(0,M.jsxs)(`div`,{className:`page-container`,children:[(0,M.jsx)(`div`,{className:`page-header`,children:(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`Admin Panel`}),(0,M.jsxs)(`p`,{children:[`Welcome, `,e?.name||`Admin`]})]})}),(0,M.jsxs)(`div`,{className:`admin-grid`,children:[e?.permissions?.userManagement&&(0,M.jsxs)(`button`,{className:`admin-card`,onClick:()=>t(`/admin/users`),children:[(0,M.jsx)(`span`,{className:`admin-card-icon`,children:`👥`}),(0,M.jsx)(`span`,{className:`admin-card-title`,children:`User Management`}),(0,M.jsx)(`span`,{className:`admin-card-text`,children:`Add, edit, disable or delete users and manage their permissions.`})]}),e?.permissions?.settings&&(0,M.jsxs)(`button`,{className:`admin-card`,onClick:()=>t(`/settings`),children:[(0,M.jsx)(`span`,{className:`admin-card-icon`,children:`⚙️`}),(0,M.jsx)(`span`,{className:`admin-card-title`,children:`Settings`}),(0,M.jsx)(`span`,{className:`admin-card-text`,children:`Manage dashboard notice and places.`})]})]}),!e?.permissions?.userManagement&&!e?.permissions?.settings&&(0,M.jsx)(`div`,{className:`settings-empty`,children:`You do not have any admin actions available.`})]})}function Nr(){let{user:e}=vr(),[t,n]=(0,x.useState)([]),[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(!0),[s,c]=(0,x.useState)(!1),[l,u]=(0,x.useState)(null),[d,f]=(0,x.useState)({name:``,email:``,password:``,role:`user`,login:!0}),[p,m]=(0,x.useState)({viewCollections:!1,addCollection:!1,editCollection:!1,deleteCollection:!1,reports:!1,settings:!1,userManagement:!1,transactions:!1,addTransaction:!1,editTransaction:!1,deleteTransaction:!1}),[h,g]=(0,x.useState)(!1);async function _(){o(!0);let t=await Yn(e.id);t.success?n(t.users||[]):alert(t.message||`Unable to load users.`),o(!1)}(0,x.useEffect)(()=>{e?.id&&_()},[e?.id]);let v=t.filter(e=>{let t=r.trim().toLowerCase();return!t||String(e.id||``).toLowerCase().includes(t)||String(e.name||``).toLowerCase().includes(t)||String(e.email||``).toLowerCase().includes(t)||String(e.role||``).toLowerCase().includes(t)});function y(){u(null),f({name:``,email:``,password:``,role:`user`,login:!0}),m({viewCollections:!1,addCollection:!1,editCollection:!1,deleteCollection:!1,reports:!1,settings:!1,userManagement:!1,transactions:!1,addTransaction:!1,editTransaction:!1,deleteTransaction:!1}),c(!0)}async function b(t){u(t),f({name:t.name||``,email:t.email||``,password:``,role:t.role||`user`,login:t.login===!0||t.login===`TRUE`}),m({viewCollections:!1,addCollection:!1,editCollection:!1,deleteCollection:!1,reports:!1,settings:!1,userManagement:!1,transactions:!1,addTransaction:!1,editTransaction:!1,deleteTransaction:!1}),c(!0);let n=await $n(e.id,t.id);n.success&&m({viewCollections:n.permissions?.viewCollections===!0,addCollection:n.permissions?.addCollection===!0,editCollection:n.permissions?.editCollection===!0,deleteCollection:n.permissions?.deleteCollection===!0,reports:n.permissions?.reports===!0,settings:n.permissions?.settings===!0,userManagement:n.permissions?.userManagement===!0,transactions:n.permissions?.transactions===!0,addTransaction:n.permissions?.addTransaction===!0,editTransaction:n.permissions?.editTransaction===!0,deleteTransaction:n.permissions?.deleteTransaction===!0})}function S(e){let{name:t,value:n,type:r,checked:i}=e.target;f(e=>({...e,[t]:r===`checkbox`?i:n}))}function C(e){m(t=>({...t,[e]:!t[e]}))}async function w(t){if(t.preventDefault(),!d.name.trim()){alert(`Please enter name.`);return}if(!d.email.trim()){alert(`Please enter email.`);return}if(!l&&!d.password.trim()){alert(`Please enter password.`);return}g(!0);let n;if(n=l?await Zn(e.id,{id:l.id,name:d.name,email:d.email,password:d.password.trim(),role:d.role,login:d.login}):await Xn(e.id,{name:d.name,email:d.email,password:d.password.trim(),role:d.role,login:d.login}),!n.success){alert(n.message||`Unable to save user.`),g(!1);return}let r=l?.id||n.user?.id||n.id;if(r){let t=await er(e.id,r,p);t.success||alert(t.message||`User saved, but permissions could not be saved.`)}c(!1),await _(),g(!1)}async function T(t){if(String(t.id)===String(e.id)){alert(`You cannot delete your own account.`);return}if(!window.confirm(`Delete ${t.name}?`))return;let n=await Qn(e.id,t.id);if(!n.success){alert(n.message||`Unable to delete user.`);return}await _()}function ee(){h||c(!1)}return a?(0,M.jsxs)(`div`,{className:`um-loading`,children:[(0,M.jsx)(`div`,{className:`um-spinner`}),(0,M.jsx)(`p`,{children:`Loading users...`})]}):(0,M.jsxs)(`div`,{className:`user-management`,children:[(0,M.jsxs)(`div`,{className:`um-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h1`,{children:`User Management`}),(0,M.jsx)(`p`,{children:`Manage users, login access and permissions.`})]}),(0,M.jsx)(`button`,{className:`um-add-btn`,onClick:y,children:`+ New User`})]}),(0,M.jsxs)(`div`,{className:`um-search-box`,children:[(0,M.jsx)(`span`,{className:`um-search-icon`,children:`🔍`}),(0,M.jsx)(`input`,{type:`text`,value:r,onChange:e=>i(e.target.value),placeholder:`Search by ID, name, email or role...`}),r&&(0,M.jsx)(`button`,{className:`um-search-clear`,onClick:()=>i(``),children:`×`})]}),r&&(0,M.jsxs)(`div`,{className:`um-search-info`,children:[`Showing`,` `,(0,M.jsx)(`strong`,{children:v.length}),` `,`of`,` `,(0,M.jsx)(`strong`,{children:t.length}),` `,`users`]}),(0,M.jsx)(`div`,{className:`um-table-wrapper`,children:(0,M.jsxs)(`table`,{className:`um-table`,children:[(0,M.jsx)(`thead`,{children:(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`th`,{children:`ID`}),(0,M.jsx)(`th`,{children:`Name`}),(0,M.jsx)(`th`,{children:`Email`}),(0,M.jsx)(`th`,{children:`Role`}),(0,M.jsx)(`th`,{children:`Login`}),(0,M.jsx)(`th`,{children:`Actions`})]})}),(0,M.jsx)(`tbody`,{children:v.length===0?(0,M.jsx)(`tr`,{children:(0,M.jsx)(`td`,{colSpan:`6`,className:`um-empty`,children:r?`No matching users found.`:`No users found.`})}):v.map(e=>(0,M.jsxs)(`tr`,{children:[(0,M.jsx)(`td`,{children:e.id}),(0,M.jsx)(`td`,{className:`um-name`,children:e.name}),(0,M.jsx)(`td`,{children:e.email}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:e.role===`admin`?`um-role admin`:`um-role user`,children:e.role})}),(0,M.jsx)(`td`,{children:(0,M.jsx)(`span`,{className:e.login===!0||e.login===`TRUE`?`um-login active`:`um-login disabled`,children:e.login===!0||e.login===`TRUE`?`Enabled`:`Disabled`})}),(0,M.jsx)(`td`,{children:(0,M.jsxs)(`div`,{className:`um-actions`,children:[(0,M.jsx)(`button`,{onClick:()=>b(e),className:`um-edit`,children:`Edit`}),(0,M.jsx)(`button`,{onClick:()=>T(e),className:`um-delete`,children:`Delete`})]})})]},e.id))})]})}),(0,M.jsx)(`div`,{className:`um-mobile-list`,children:v.length===0?(0,M.jsx)(`div`,{className:`um-empty-card`,children:r?`No matching users found.`:`No users found.`}):v.map(e=>(0,M.jsxs)(`div`,{className:`um-user-card`,children:[(0,M.jsxs)(`div`,{className:`um-card-top`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`strong`,{children:e.name}),(0,M.jsxs)(`small`,{children:[`ID: `,e.id]})]}),(0,M.jsx)(`span`,{className:e.role===`admin`?`um-role admin`:`um-role user`,children:e.role})]}),(0,M.jsx)(`div`,{className:`um-card-email`,children:e.email}),(0,M.jsx)(`div`,{className:`um-card-status`,children:(0,M.jsxs)(`span`,{children:[`Login:`,(0,M.jsx)(`b`,{children:e.login===!0||e.login===`TRUE`?` Enabled`:` Disabled`})]})}),(0,M.jsxs)(`div`,{className:`um-card-actions`,children:[(0,M.jsx)(`button`,{onClick:()=>b(e),className:`um-edit`,children:`Edit`}),(0,M.jsx)(`button`,{onClick:()=>T(e),className:`um-delete`,children:`Delete`})]})]},e.id))}),s&&(0,M.jsx)(`div`,{className:`um-overlay`,onMouseDown:e=>{e.target===e.currentTarget&&ee()},children:(0,M.jsxs)(`div`,{className:`um-popup`,children:[(0,M.jsxs)(`div`,{className:`um-popup-header`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{children:l?`Edit User`:`New User`}),(0,M.jsx)(`p`,{children:`Account details and permissions`})]}),(0,M.jsx)(`button`,{className:`um-close`,onClick:ee,children:`×`})]}),(0,M.jsxs)(`form`,{onSubmit:w,children:[(0,M.jsxs)(`div`,{className:`um-section`,children:[(0,M.jsx)(`h3`,{children:`User Details`}),(0,M.jsxs)(`div`,{className:`um-form-grid`,children:[(0,M.jsxs)(`div`,{className:`um-field`,children:[(0,M.jsx)(`label`,{children:`Name`}),(0,M.jsx)(`input`,{name:`name`,value:d.name,onChange:S,placeholder:`Enter name`})]}),(0,M.jsxs)(`div`,{className:`um-field`,children:[(0,M.jsx)(`label`,{children:`Email`}),(0,M.jsx)(`input`,{type:`email`,name:`email`,value:d.email,onChange:S,placeholder:`Enter email`})]}),(0,M.jsxs)(`div`,{className:`um-field`,children:[(0,M.jsxs)(`label`,{children:[`Password`,l&&(0,M.jsx)(`span`,{className:`um-password-hint`,children:`Leave blank to keep the current password`})]}),(0,M.jsx)(`input`,{type:`password`,name:`password`,value:d.password,onChange:S,placeholder:l?`Enter new password (optional)`:`Enter password`,autoComplete:`new-password`})]}),(0,M.jsxs)(`div`,{className:`um-field`,children:[(0,M.jsx)(`label`,{children:`Role`}),(0,M.jsxs)(`select`,{name:`role`,value:d.role,onChange:S,children:[(0,M.jsx)(`option`,{value:`user`,children:`User`}),(0,M.jsx)(`option`,{value:`admin`,children:`Admin`})]})]})]}),(0,M.jsxs)(`label`,{className:`um-check single`,children:[(0,M.jsx)(`input`,{type:`checkbox`,name:`login`,checked:d.login,onChange:S}),(0,M.jsx)(`span`,{children:`Login Enabled`})]})]}),(0,M.jsxs)(`div`,{className:`um-section`,children:[(0,M.jsx)(`h3`,{children:`Permissions`}),(0,M.jsxs)(`div`,{className:`um-permission-grid`,children:[(0,M.jsx)(Pr,{label:`View Collections`,checked:p.viewCollections,onChange:()=>C(`viewCollections`)}),(0,M.jsx)(Pr,{label:`Add Collection`,checked:p.addCollection,onChange:()=>C(`addCollection`)}),(0,M.jsx)(Pr,{label:`Edit Collection`,checked:p.editCollection,onChange:()=>C(`editCollection`)}),(0,M.jsx)(Pr,{label:`Delete Collection`,checked:p.deleteCollection,onChange:()=>C(`deleteCollection`)}),(0,M.jsx)(Pr,{label:`Reports`,checked:p.reports,onChange:()=>C(`reports`)}),(0,M.jsx)(Pr,{label:`Settings`,checked:p.settings,onChange:()=>C(`settings`)}),(0,M.jsx)(Pr,{label:`User Management`,checked:p.userManagement,onChange:()=>C(`userManagement`)}),(0,M.jsx)(Pr,{label:`Transactions`,checked:p.transactions,onChange:()=>C(`transactions`)}),(0,M.jsx)(Pr,{label:`Add Transaction`,checked:p.addTransaction,onChange:()=>C(`addTransaction`)}),(0,M.jsx)(Pr,{label:`Edit Transaction`,checked:p.editTransaction,onChange:()=>C(`editTransaction`)}),(0,M.jsx)(Pr,{label:`Delete Transaction`,checked:p.deleteTransaction,onChange:()=>C(`deleteTransaction`)})]})]}),(0,M.jsxs)(`div`,{className:`um-popup-footer`,children:[(0,M.jsx)(`button`,{type:`button`,onClick:ee,className:`um-cancel`,disabled:h,children:`Cancel`}),(0,M.jsx)(`button`,{type:`submit`,className:`um-save`,disabled:h,children:h?`Saving...`:l?`Update User`:`Create User`})]})]})]})}),(0,M.jsx)(`style`,{children:`
      ...
      `})]})}function Pr({label:e,checked:t,onChange:n}){return(0,M.jsxs)(`label`,{className:`um-check`,children:[(0,M.jsx)(`input`,{type:`checkbox`,checked:t,onChange:n}),(0,M.jsx)(`span`,{children:e})]})}function Fr(){let[e,t]=(0,x.useState)(!1);return(0,M.jsxs)(`div`,{className:`app-layout`,children:[(0,M.jsx)(Cr,{open:e,onClose:()=>t(!1)}),(0,M.jsxs)(`div`,{className:`main-area`,children:[(0,M.jsx)(Sr,{onMenuClick:()=>t(!0)}),(0,M.jsx)(`main`,{className:`main-content`,children:(0,M.jsxs)(Yt,{children:[(0,M.jsx)(A,{path:`/`,element:(0,M.jsx)(Er,{})}),(0,M.jsx)(A,{path:`/dashboard`,element:(0,M.jsx)(Er,{})}),(0,M.jsx)(A,{path:`/profile`,element:(0,M.jsx)(jr,{})}),(0,M.jsx)(A,{element:(0,M.jsx)(br,{permission:`viewCollections`}),children:(0,M.jsx)(A,{path:`/collections`,element:(0,M.jsx)(Dr,{})})}),(0,M.jsx)(A,{element:(0,M.jsx)(br,{permission:`reports`}),children:(0,M.jsx)(A,{path:`/reports`,element:(0,M.jsx)(Or,{})})}),(0,M.jsx)(A,{element:(0,M.jsx)(br,{permission:`transactions`}),children:(0,M.jsx)(A,{path:`/transactions`,element:(0,M.jsx)(kr,{})})}),(0,M.jsx)(A,{element:(0,M.jsx)(br,{permission:`settings`}),children:(0,M.jsx)(A,{path:`/settings`,element:(0,M.jsx)(Ar,{})})}),(0,M.jsxs)(A,{element:(0,M.jsx)(xr,{}),children:[(0,M.jsx)(A,{path:`/admin`,element:(0,M.jsx)(Mr,{})}),(0,M.jsx)(A,{element:(0,M.jsx)(br,{permission:`userManagement`}),children:(0,M.jsx)(A,{path:`/admin/users`,element:(0,M.jsx)(Nr,{})})})]})]})})]})]})}function Ir(){return(0,M.jsx)(Pn,{children:(0,M.jsx)(_r,{children:(0,M.jsxs)(Yt,{children:[(0,M.jsx)(A,{path:`/login`,element:(0,M.jsx)(wr,{})}),(0,M.jsx)(A,{path:`/public-collections`,element:(0,M.jsx)(Tr,{})}),(0,M.jsx)(A,{element:(0,M.jsx)(yr,{}),children:(0,M.jsx)(A,{path:`*`,element:(0,M.jsx)(Fr,{})})})]})})})}Kn.createRoot(document.getElementById(`root`)).render((0,M.jsx)(x.StrictMode,{children:(0,M.jsx)(Ir,{})}));